                ...
                <tbody>
                    ...
                    @foreach ($profiles as $profile)
                        <tr class='border-2 border-[#000]'>
                            <td class='py-2 px-2'>
                                <div class='hw-[100%] rounded relative flex justify-center'><img width='100px'
                                        class='w-[80px]'>{{ $profile->image }}</div>
                            </td>
                            ...
                            <td class='py-2 px-2 border-2 border-[#000]'>
                                <form method='post'>
                                    ...
                                    <button
                                        ...
                                        style='transition-duration: 0.5s;' name='deleteUser'>Delete</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
